// Dynamic OG card for /surf — when a player shares their ride, the cast
// embed itself shows their distance and dares friends to beat it.

import { ImageResponse } from "next/og";
import { NextRequest } from "next/server";
import { SURF_DISPLAY_URL } from "../../../../lib/surfShare";
...
export async function GET(request: NextRequest) {
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Surf vista as the backdrop: dark sky left, river right */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src={`${baseUrl}/surf/og-bg.jpg`}
          width={1200}
          height={800}
          alt=""
          style={{
